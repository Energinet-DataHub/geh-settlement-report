...
using Energinet.DataHub.SettlementReport.Infrastructure.Mappers.DeltaTableConstants;
using Energinet.DataHub.SettlementReport.Interfaces.Models;

namespace Energinet.DataHub.SettlementReport.Infrastructure.Mappers;
