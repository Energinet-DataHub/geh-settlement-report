...
public class SettlementReportRepositoryTests : IClassFixture<WholesaleDatabaseFixture<SettlementReportDatabaseContext>>
{
    ...
    public async Task AddOrUpdateAsync_ValidRequest_PersistsChanges()
    {
        ...
        var settlementReportRequest = new SettlementReport.CalculationResults.Application.SettlementReports_v2.SettlementReport(
    ...
    public async Task DeleteAsync_GivenRequest_RequestIsDeleted()
    {
        ...
        var settlementReport = new SettlementReport.CalculationResults.Application.SettlementReports_v2.SettlementReport(
            SystemClock.Instance,
            Guid.NewGuid(),
            Guid.NewGuid(),
            false,
    ...
    {
        // arrange
        IEnumerable<SettlementReport.CalculationResults.Application.SettlementReports_v2.SettlementReport> preparedRequests =
        [
    ...
    public async Task GetAsync_HiddenReport_ReturnsRequests()
    {
        // Arrange
        var expectedRequest = await PrepareNewRequestAsync();
        await PrepareNewRequestAsync(requestFilterDto => new SettlementReport.CalculationResults.Application.SettlementReports_v2.SettlementReport(
            SystemClock.Instance,
            Guid.NewGuid(),
            Guid.NewGuid(),
            true,
    ...
    private async Task<SettlementReport.CalculationResults.Application.SettlementReports_v2.SettlementReport> PrepareNewRequestAsync(Func<SettlementReportRequestFilterDto, SettlementReport.CalculationResults.Application.SettlementReports_v2.SettlementReport>? createReport = null)
    {
