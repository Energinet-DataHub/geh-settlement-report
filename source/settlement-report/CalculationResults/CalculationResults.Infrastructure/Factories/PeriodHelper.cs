...
using EnergyResultsResolution = Energinet.DataHub.SettlementReport.CalculationResults.Interfaces.CalculationResults.Model.EnergyResults.Resolution;
using InternalPeriod = Energinet.DataHub.SettlementReport.CalculationResults.Interfaces.CalculationResults.Model.Period;
using WholesaleResolution = Energinet.DataHub.SettlementReport.CalculationResults.Interfaces.CalculationResults.Model.WholesaleResults.Resolution;

namespace Energinet.DataHub.SettlementReport.CalculationResults.Infrastructure.Factories;
