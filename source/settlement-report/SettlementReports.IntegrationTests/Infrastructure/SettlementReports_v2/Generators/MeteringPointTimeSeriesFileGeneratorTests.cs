...
public sealed class MeteringPointTimeSeriesFileGeneratorTests
{
    ...
    public async Task Write_DataSourceRowFound_WritesExpectedCsv(Resolution resolution)
    {
        ...
        dataSourceMock
            .Setup(x => x.GetAsync(It.IsAny<SettlementReportRequestFilterDto>(), It.IsAny<SettlementReportRequestedByActor>(), 1, resolution, It.IsAny<int>(), It.IsAny<int>()))
            .Returns(
    ...
    public async Task Write_DataSourceRowFound_WritesExpectedQuotedColumnsCsv()
    {
        ...
        dataSourceMock
            .Setup(x => x.GetAsync(It.IsAny<SettlementReportRequestFilterDto>(), It.IsAny<SettlementReportRequestedByActor>(), 1, Resolution.Hour, It.IsAny<int>(), It.IsAny<int>()))
            .Returns(
                new List<SettlementReportMeteringPointTimeSeriesResultRow>
                {
                    new(
