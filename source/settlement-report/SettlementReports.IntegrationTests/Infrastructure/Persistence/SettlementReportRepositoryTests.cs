...
public class SettlementReportRepositoryTests : IClassFixture<WholesaleDatabaseFixture<SettlementReportDatabaseContext>>
{
    ...
    public async Task AddOrUpdateAsync_ValidRequest_PersistsChanges()
    {
        ...
        var settlementReportRequest = new SettlementReport.Application.Model.SettlementReport(
    ...
    public async Task DeleteAsync_GivenRequest_RequestIsDeleted()
    {
        ...
        var settlementReport = new SettlementReport.Application.Model.SettlementReport(
            SystemClock.Instance,
            Guid.NewGuid(),
            Guid.NewGuid(),
            false,
    ...
    {
        // arrange
        IEnumerable<SettlementReport.Application.Model.SettlementReport> preparedRequests =
        [
    ...
    public async Task GetAsync_HiddenReport_ReturnsRequests()
    {
        // Arrange
        var expectedRequest = await PrepareNewRequestAsync();
        await PrepareNewRequestAsync(requestFilterDto => new SettlementReport.Application.Model.SettlementReport(
            SystemClock.Instance,
            Guid.NewGuid(),
    ...
    public async Task GetAsync_HiddenReport_ReturnsRequestsForJobs()
    {
        // Arrange
        var expectedRequest = await PrepareNewRequestForJobAsync();
        await PrepareNewRequestForJobAsync(requestFilterDto => new SettlementReport.Application.Model.SettlementReport(
            SystemClock.Instance,
            Guid.NewGuid(),
            expectedRequest.ActorId,
            true,
    ...
    public async Task GetForNotificationAsync_ReturnsNone_WhenNoneArePresent()
    {
        ...
        {
            var request = new SettlementReport.Application.Model.SettlementReport(
                SystemClock.Instance,
                Guid.NewGuid(),
                Guid.NewGuid(),
                false,
    ...
    private async Task<SettlementReport.Application.Model.SettlementReport> PrepareNewRequestAsync(Func<SettlementReportRequestFilterDto, SettlementReport.Application.Model.SettlementReport>? createReport = null)
    {
    ...
    private async Task<SettlementReport.Application.Model.SettlementReport> PrepareNewRequestForJobAsync(Func<SettlementReportRequestFilterDto, SettlementReport.Application.Model.SettlementReport>? createReport = null)
    {
        await using var setupContext = _databaseManager.CreateDbContext();
        var setupRepository = new SettlementReportRepository(setupContext);
