...
using NodaTime;
using CalculationState = Energinet.DataHub.SettlementReport.Calculations.Interfaces.Models.CalculationState;

namespace Energinet.DataHub.SettlementReport.Calculations.Application;
