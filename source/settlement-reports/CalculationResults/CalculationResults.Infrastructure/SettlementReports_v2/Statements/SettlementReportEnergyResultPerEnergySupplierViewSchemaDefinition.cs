...
namespace Energinet.DataHub.SettlementReport.CalculationResults.Infrastructure.SettlementReports_v2.Statements;

public class SettlementReportEnergyResultPerEnergySupplierViewSchemaDefinition
{
    public static Dictionary<string, (string Type, bool Nullable)> SchemaDefinition { get; } = new()
    {
        ...
        { SettlementReportEnergyResultPerEnergySupplierViewColumns.CalculationVersion, ("string", false) },
